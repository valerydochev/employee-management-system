<main className="main">
  <section className="card users-container">
    ...
    {/* Таблица + всички overlay състояния */}
      ...
      <table className="table">
        <thead>
          <tr>
            ...
            <th>
              Email
              <svg className="icon svg-inline--fa fa-arrow-down Table_icon__+HHgn" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="arrow-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                <path fill="currentColor"
                  d="M374.6 310.6l-160 160C208.4 476.9 200.2 480 192 480s-16.38-3.125-22.62-9.375l-160-160c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L160 370.8V64c0-17.69 14.33-31.1 31.1-31.1S224 46.31 224 64v306.8l105.4-105.4c12.5-12.5 32.75-12.5 45.25 0S387.1 298.1 374.6 310.6z">
                </path>
              </svg>
            ...
            <td className="actions">
              ...
              <button className="btn delete-btn" title="Delete">
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash"
                  className="svg-inline--fa fa-trash" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                  <path fill="currentColor"
      ...
      <div className="actions">
        <button className="btn" title="First Page">
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angles-left"
            ...
            <path fill="currentColor"
              d="M77.25 256l137.4-137.4c12.5-12.5 12.5-32.75 0-45.25s-32.75-12.5-45.25 0l-160 160c-12.5 12.5-12.5 32.75 0 45.25l160 160c6.248 6.248 14.41 9.373 22.62 9.373s16.38-3.125 22.62-9.373c12.5-12.5 12.5-32.75 0-45.25L77.25 256zm192 0l137.4-137.4c12.5-12.5 12.5-32.75 0-45.25s-32.75-12.5-45.25 0l-160 160c-12.5 12.5-12.5 32.75 0 45.25l160 160c6.248 6.248 14.41 9.373 22.62 9.373s16.38-3.125 22.62-9.373c12.5-12.5 12.5-32.75 0-45.25L269.3 256z"/>
          </svg>
        </button>
        ...
        <button className="btn" title="Last Page">
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angles-right"
            ...
            <path fill="currentColor"
              d="M246.6 233.4l-160-160c-12.5-12.5-32.75-12.5-45.25 0s-12.5 32.75 0 45.25L178.8 256l-137.4 137.4c-12.5 12.5-12.5 32.75 0 45.25C47.63 444.9 55.81 448 64 448s16.38-3.125 22.62-9.375l160-160C259.1 266.1 259.1 245.9 246.6 233.4zm192 0l-160-160c-12.5-12.5-32.75-12.5-45.25 0s-12.5 32.75 0 45.25L370.8 256l-137.4 137.4c-12.5 12.5-12.5 32.75 0 45.25C239.6 444.9 247.8 448 256 448s16.38-3.125 22.62-9.375l160-160C451.1 266.1 451.1 245.9 438.6 233.4z"/>
          </svg>
        </button>
      </div>
    </div>

    {/* ВСИЧКИ МОДАЛИ СА ТУК – активни, не са коментирани */}
      ...
      <div className="modal">
        <div className="user-container">
          ...
          <form>
            ...
            {/* ... и останалите полета точно както бяха в оригинала ... */}
            <div id="form-actions">
